...
<body>
    ...
    <!-- navbar -->
    <h2 style="text-align: center; margin-top: 1%; color:red;"> Donor Registration </h2>
    <div class="container">
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputPassword" name="Blood">
            </div>
            <div class="form-group">
            ...
            <div class="lbtn">Already Register? <a href="D_login.php">Login Here..!</a></div> 
        </form>
    </div>
    ...
    <footer class=" text-center work_f">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.05);">
            © 2020 Copyright:
            <a class="text-body" href="https://mdbootstrap.com/">www.REDCROSS.com</a>
        </div>
        <!-- Copyright -->
    </footer>
    <!-- Footer -->
